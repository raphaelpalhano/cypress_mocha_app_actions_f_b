...
module.exports = defineConfig({
  ...
  env: {
    ...
    USERS: {
      ...
      USER_MANAGER: 'gestor.prod@mailinator.com',
      USER_INVESTOR: 'investidor.prod@mailinator.com',
      USER_SUPPLIER: 'fornecedor.prod@mailinator.com',
